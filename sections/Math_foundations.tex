...
\textbf{Step 1.} Select two distinct large primes $p$ and $q$, verified using the Miller-Rabin primality test.
...
If $H' = H$, the signature is valid—proving both authenticity and data integrity.