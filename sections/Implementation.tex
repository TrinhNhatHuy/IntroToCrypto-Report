...
The system is implemented as a single Python script (\texttt{main.py}, 195 lines) using only standard libraries: \texttt{random} and \texttt{hashlib}. No external cryptographic packages are used—all mathematical operations are implemented from scratch.
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{images/output_step1.png}
%   \caption{Program output: Hash comparison and key generation.}
% \end{figure}
%
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{images/output_step2.png}
%   \caption{Program output: Signing, verification, and tampering detection.}
% \end{figure}

\textit{(Screenshots of the program output will be inserted here after running \texttt{main.py}.)}
